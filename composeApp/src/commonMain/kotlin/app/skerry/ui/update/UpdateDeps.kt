...
import app.skerry.shared.update.R2ReleaseClient
...
/**
 * Assembles the update-notice controller over the vault-backed toggle and the R2 version.json
...
fun updateNoticeController(vault: Vault, scope: CoroutineScope): UpdateNoticeController {
    ...
    val checker = UpdateChecker(AppVersion.VERSION) { R2ReleaseClient.fetchOnce() }
