...
gradle.allprojects {
    ...
    if (name == "sync-wire") {
        buildscript {
            ...
            marker("org.jetbrains.kotlin.multiplatform", "2.4.10")
            marker("org.jetbrains.kotlin.jvm", "2.4.10")
            marker("org.jetbrains.kotlin.plugin.compose", "2.4.10")
            marker("org.jetbrains.kotlin.plugin.serialization", "2.4.10")
